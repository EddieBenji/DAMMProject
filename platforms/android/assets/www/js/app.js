...
// 					'<span id="resultsGPS">0</span>' + 
            ...
            '<header><h2>' + lang.$stepSize + ' (cm): <input id="stepSizeLabel" type="number" class="settings-label"></h2></header>' +
            '<div id="stepSizeSlider"></div>' +
            '<header><h2>' + lang.$weight + ' (kg): <input id="weightLabel" type="number" class="settings-label"></h2></header>' +
